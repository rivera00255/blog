          ...
          user.uid === data.user.uid && (
            <div className={styles.buttonWrapper}>
              ...
              <button
                ...
                <span>
                  <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 12V17" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M14 12V17" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
